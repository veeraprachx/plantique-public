...
function FoggyCommand() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/foggys`,
        {
          method: "POST",
  ...
  const fetchLatestFoggyStatus = async () => {
    try {
      ...
      setFoggyStatus(latestFan.status);
  ...
  return (
    <div className="max-w-md mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">Foggy Command</h2>
